...
function LastUpdate() {
  return (
    <a
      href="https://github.com/iamfinnz/ilhamarifin.com"
      target="_blank"
  ...
  return (
    <div className={clsx('max-w-[348px]')}>
      ...
      <p className={clsx('mb-4 font-normal leading-relaxed')}>
        I&apos;m Ilham, a <strong>software developer</strong> who thrives on finding elegant solutions to complex challenges.
      </p>
      ...
      <div className={clsx('content-wrapper')}>
        ...
        >
          <div className={clsx('font-semibold')}>
            &copy; {dayjs().format('YYYY')}, Ilham Arifin
          </div>
