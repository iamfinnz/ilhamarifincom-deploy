  ...
  return (
    <div>
      ...
      >
        ...
        <m.li variants={animation}>
          <div className={clsx('transition duration-200 hover:text-[#8892BF]')}>
            <PhpIcon className={clsx('h-6 w-6')} />
          </div>
        </m.li>
        <m.li variants={animation}>
          <div
        ...
        <m.li variants={animation}>
          <div className={clsx('transition duration-200 hover:text-[#A4C639]')}>
            <AndroidStudioIcon className={clsx('h-6 w-6')} />
          </div>
        </m.li>
      </m.ul>
    </div>
